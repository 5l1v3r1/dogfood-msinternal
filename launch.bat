...
if %option% == 1 (
    ...
    set build=16.0.12314.20004
) else if %option% == 2 (
    set branch=f3260cf1-a92c-4c75-b02e-d64c0a86a968
    set build=16.0.12228.20250
) else if %option% == 3 (
    ...
    set build=16.0.12312.20002
) else if %option% == 6 (
    set branch=5462eee5-1e97-495b-9370-853cd873bb07
    set build=16.0.12228.20206
) else if %option% == 7 (
